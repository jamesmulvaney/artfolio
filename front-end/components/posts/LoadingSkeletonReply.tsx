...
type LoadingSkeletonReplyProps = {};

function LoadingSkeletonReply({}: LoadingSkeletonReplyProps) {
  return (
    <div className="flex flex-row space-x-2 items-start px-4 py-3">
      ...
      <div className="flex flex-col items-start">
        ...
        {/* Date Posted */}
        <div className="dark:bg-zinc-800 w-24 h-4 rounded-md mt-2 animate-pulse" />
        {/* Like Button */}
...
export default LoadingSkeletonReply;
